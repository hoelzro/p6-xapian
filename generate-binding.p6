...
my %native-typemap = (
    'std::string'           => 'Str',
    'bool'                  => 'int32',
    'Xapian::Query::op'     => 'uint32',
    'Xapian::docid'         => 'uint32',
    'Xapian::doccount'      => 'uint32',
    'Xapian::doclength'     => 'uint32',
    'Xapian::flags'         => 'uint32',
    'Xapian::percent'       => 'int32',
    'Xapian::stem_strategy' => 'uint32',
    'Xapian::termcount'     => 'uint32',
    'Xapian::termpos'       => 'uint32',
    'Xapian::valueno'       => 'uint32',
    'Xapian::weight'        => 'num64',
    'unsigned'              => 'uint32',
    'const char *'          => 'Str',
    'double'                => 'num64',
